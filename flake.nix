{
    ...
    inputs = {
        ...
        old-pkgs.url = "github:nixos/nixpkgs/nixos-25.11";
        home-manager = {
    ...
    in
    {
        nixosConfigurations = {
            ...
            nix-x230t = mkNixosSystem "x86_64-linux" "think-nix-x230t" "laptop";
        };
        homeConfigurations = {
            ...
            "ki11errabbit@think-nix-x230t" = mkHome "x86_64-linux" "ki11errabbit" "think-nix-x230t" "laptop";
